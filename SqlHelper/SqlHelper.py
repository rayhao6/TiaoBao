...
class SqldbHelper(object):
    """
    操作sqlite数据库，基本方法
    """

    def __init__(self, database="./SqlHelper/test.db"):
...
if __name__ == "__main__":
    ...
    print(mydb.select(table, fields=["CPU"]))
#     '''# 删除
#     key = ["id", "name", "age"]
